...
# checkpoint_path = 'model_checkpoint_pretrained_busc.pth'
...
#           itr += 1
#           logging.basicConfig(filename='pretrained_busc.log', level=logging.DEBUG)
...
# plt.savefig('train_loss_epoch_pretrained_busc.png')
mdl=torch.load('pretrained_busi.pth',map_location=torch.device('cpu'))
